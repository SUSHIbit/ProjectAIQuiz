                    ...
                    <main class="mt-6">
                        ...
                        <div class="mb-12">
                            <div class="text-center mb-8">
                                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Get Started - Upload Your Document</h2>
                                    ...
                                    <div class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            ...
                                            <p class="mt-4 text-sm/relaxed">
                                                Upload your PDF or DOCX files and let our AI generate comprehensive multiple-choice quizzes instantly. Perfect for students, teachers, and professionals looking to create engaging assessments.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            ...
                                            <p class="mt-4 text-sm/relaxed">
                                                Create custom quizzes manually with full control over questions, answers, and explanations. Export to PDF, track performance, and manage your quiz library effortlessly.
                                            </p>
                                        </div>
                                    </div>
                                </div>
