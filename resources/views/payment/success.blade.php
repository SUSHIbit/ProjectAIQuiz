        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-center">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 mb-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <br>
                                <span class="text-gray-900">{{ $payment->paid_at->format('M d, Y H:i') }}</span>
                            </div>
                            <div>
                    ...
                    <!-- Premium Features -->
                    <div class="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-lg p-6 mb-6 text-white">
                        <h4 class="text-lg font-bold mb-4">🎉 Welcome to Premium!</h4>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <p class="text-sm text-gray-500 mb-2">Need a receipt? Contact support with reference: {{ $payment->payment_ref }}</p>
                    </div>
                </div>
            </div>
        </div>
