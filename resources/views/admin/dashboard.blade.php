                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ number_format($premiumUsers) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ number_format($successfulPayments) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between">
                                <span class="text-sm text-gray-500">Free Users</span>
                                <span class="text-sm font-medium text-gray-600">{{ $freeUsers }} ({{ round(($freeUsers / max($totalUsers, 1)) * 100, 1) }}%)</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-sm text-gray-500">Premium Users</span>
